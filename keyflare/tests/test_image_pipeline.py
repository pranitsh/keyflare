...
def test_image():
    ...
    """
    test_image_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "images", "tests.jpg")
    return np.array(Image.open(test_image_path))

@pytest.mark.benchmark(min_rounds=10)
def test_image_pipeline(benchmark, test_image):
    """
...
@pytest.mark.benchmark(min_rounds=10)
def test_old_image_pipeline(benchmark, test_image):
    """
